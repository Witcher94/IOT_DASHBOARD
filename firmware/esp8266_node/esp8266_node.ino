...
#define LED_PIN         LED_BUILTIN  // Usually D4/GPIO2
...
String buildMetricsJson() {
    StaticJsonDocument<384> doc;  // Smaller for ESP8266
...
void sendMetrics() {
    ...
    // Blink LED (inverted on most ESP8266 boards)
    ledState = !ledState;
...
void setup() {
    ...
    Serial.println("\n\n=== ESP8266 Mesh Node v" FIRMWARE_VERSION " ===");
