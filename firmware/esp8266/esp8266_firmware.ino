...
void loadConfig() {
  ...
  if (cfg.magic != CONFIG_MAGIC) {
    ...
    strcpy(cfg.nodeName, "ESP8266-Node");
...
void sendMetricsTask() {
  ...
  if (String(cfg.backendUrl).startsWith("https")) {
    BearSSL::WiFiClientSecure *secClient = new BearSSL::WiFiClientSecure;
...
<body>
  ...
  <div class="card">
    <form action="/save" method="POST">
      ...
      <div class="checkbox-label">
        ...
        <label for="dht" style="margin:0">Enable DHT22</label>
      </div>
  ...
  <div class="card">
    <h3>📊 Data</h3>
    <button onclick="location.href='/metrics'">View JSON</button>
  </div>
</body>
</html>
)rawliteral";
...
void setup() {
  Serial.begin(115200);
  delay(1000);
  Serial.println("\n=== ESP8266 IoT v" FIRMWARE_VERSION " ===");
