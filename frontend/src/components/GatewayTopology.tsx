    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div>
            <div className="text-sm text-dark-400 mb-1">Platform</div>
            <div className="text-lg font-semibold text-dark-300">
              {topology.gateway.platform || 'N/A'}
            </div>
          </div>
          <div>
        ...
        {topology.mesh_nodes.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {topology.mesh_nodes.map((node: Device, index: number) => (
              ...
              >
                {/* Connection Line */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-4 bg-dark-600" />
