...
export const translations = {
  uk: {
    ...
    manageCards: 'Клікніть для керування картками',
    accessControl: 'Система контролю доступу',
    selectDevice: 'Виберіть пристрій',
    noSkudDevices: 'SKUD пристроїв не знайдено. Створіть на сторінці Пристрої.',
    linkCard: 'Прив\'язати',
    unlinkCard: 'Відв\'язати',
    admin: 'Адмін',
    ...
    // SKUD (Access Control)
    cards: 'Картки',
    accessDevices: 'Пристрої СКУД',
    accessLogs: 'Журнал доступу',
    addAccessDevice: 'Додати пристрій',
    ...
    pending: 'Очікує',
    active: 'Активна',
    disabled: 'Заблокована',
    noCardsFound: 'Карток не знайдено',
    noAccessDevices: 'Пристроїв СКУД не знайдено',
    cardStatusUpdated: 'Статус картки оновлено',
    deviceCreatedSkud: 'Пристрій СКУД створено',
    linkedDevices: 'Прив\'язані пристрої',
  ...
  en: {
    ...
    manageCards: 'Click to manage cards',
    accessControl: 'Access Control System',
    selectDevice: 'Select Device',
    noSkudDevices: 'No SKUD devices found. Create one in Devices page.',
    linkCard: 'Link',
    unlinkCard: 'Unlink',
    admin: 'Admin',
    settings: 'Settings',
    ...
    // SKUD (Access Control)
    cards: 'Cards',
    accessDevices: 'SKUD Devices',
    accessLogs: 'Access Logs',
    addAccessDevice: 'Add Device',
    deviceId: 'Device ID',
    ...
    noAccessDevices: 'No SKUD devices found',
    cardStatusUpdated: 'Card status updated',
    deviceCreatedSkud: 'SKUD device created',
